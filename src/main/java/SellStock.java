...
public class SellStock extends ServiceCommand {

    public SellStock(String identifier, String description) {
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] params) {
        ...
        try {
            ...
            bankApi.sellStock((SandboxOpenApi) api, stockFigi,stockLot);
